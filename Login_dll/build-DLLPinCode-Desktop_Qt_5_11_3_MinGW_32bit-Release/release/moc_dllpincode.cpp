...
QT_MOC_LITERAL(1, 11, 8), // "checkPin"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 9), // "pinStatus"
QT_MOC_LITERAL(4, 31, 10), // "receivePin"
QT_MOC_LITERAL(5, 42, 11) // "pinReceived"

    },
    "DLLPinCode\0checkPin\0\0pinStatus\0"
    "receivePin\0pinReceived"
};
...
void DLLPinCode::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->checkPin((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->pinStatus((*reinterpret_cast< bool(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DLLPinCode::checkPin)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DLLPinCode::pinStatus)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject DLLPinCode::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DLLPinCode.data,
...
// SIGNAL 0
void DLLPinCode::checkPin(QString _t1)
{
...
// SIGNAL 1
void DLLPinCode::pinStatus(bool _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
