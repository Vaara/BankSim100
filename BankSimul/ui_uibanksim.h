...
public:
    ...
    void setupUi(QWidget *UIBankSim)
    {
        if (UIBankSim->objectName().isEmpty())
            UIBankSim->setObjectName(QStringLiteral("UIBankSim"));
        ...
        groupBoxNav->setObjectName(QStringLiteral("groupBoxNav"));
        groupBoxNav->setGeometry(QRect(19, 19, 1841, 1001));
        buttonWithdraw = new QPushButton(groupBoxNav);
        buttonWithdraw->setObjectName(QStringLiteral("buttonWithdraw"));
        ...
        buttonBalance->setObjectName(QStringLiteral("buttonBalance"));
        ...
        labelATM->setObjectName(QStringLiteral("labelATM"));
        ...
        buttonTransactions->setObjectName(QStringLiteral("buttonTransactions"));
        ...
        groupBoxBalance->setObjectName(QStringLiteral("groupBoxBalance"));
        groupBoxBalance->setGeometry(QRect(20, 20, 1841, 1001));
        labelTitleAccountBalance = new QLabel(groupBoxBalance);
        labelTitleAccountBalance->setObjectName(QStringLiteral("labelTitleAccountBalance"));
        ...
        labelTitleSaldo->setObjectName(QStringLiteral("labelTitleSaldo"));
        ...
        buttonBackBalance->setObjectName(QStringLiteral("buttonBackBalance"));
        ...
        widgetBalance->setObjectName(QStringLiteral("widgetBalance"));
        widgetBalance->setGeometry(QRect(630, 260, 581, 361));
        labelTitleAccountHolder = new QLabel(groupBoxBalance);
        labelTitleAccountHolder->setObjectName(QStringLiteral("labelTitleAccountHolder"));
        ...
        button140->setObjectName(QStringLiteral("button140"));
        button140->setGeometry(QRect(940, 300, 331, 111));
        button140->setFont(font2);
        button140->setStyleSheet(QStringLiteral(""));
        ...
        button20->setStyleSheet(QStringLiteral(""));
        button60 = new QPushButton(groupBoxWithdraw);
        button60->setObjectName(QStringLiteral("button60"));
        button60->setGeometry(QRect(590, 430, 331, 111));
        button60->setFont(font2);
        button60->setStyleSheet(QStringLiteral(""));
        buttonBackWithdraw = new QPushButton(groupBoxWithdraw);
        buttonBackWithdraw->setObjectName(QStringLiteral("buttonBackWithdraw"));
        ...
        withdrawCustom->setObjectName(QStringLiteral("withdrawCustom"));
        groupBoxWithdrawCustom = new QGroupBox(withdrawCustom);
        groupBoxWithdrawCustom->setObjectName(QStringLiteral("groupBoxWithdrawCustom"));
        ...
        labelTitleCustomAmount->setObjectName(QStringLiteral("labelTitleCustomAmount"));
        ...
        groupBoxTransactions->setObjectName(QStringLiteral("groupBoxTransactions"));
        groupBoxTransactions->setGeometry(QRect(19, 19, 1841, 1001));
        LabelTitleLastLogin = new QLabel(groupBoxTransactions);
        LabelTitleLastLogin->setObjectName(QStringLiteral("LabelTitleLastLogin"));
        ...
        widgetTransaction->setObjectName(QStringLiteral("widgetTransaction"));
        widgetTransaction->setGeometry(QRect(580, 210, 691, 471));
        buttonBackTransactions = new QPushButton(groupBoxTransactions);
        buttonBackTransactions->setObjectName(QStringLiteral("buttonBackTransactions"));
        ...
        labelTitleBalance->setObjectName(QStringLiteral("labelTitleBalance"));
        ...
        withdrawDone->setObjectName(QStringLiteral("withdrawDone"));
        groupBoxWithdrawDone = new QGroupBox(withdrawDone);
        groupBoxWithdrawDone->setObjectName(QStringLiteral("groupBoxWithdrawDone"));
        groupBoxWithdrawDone->setGeometry(QRect(20, 20, 1841, 1001));
        labelEuroTitle = new QLabel(groupBoxWithdrawDone);
        labelEuroTitle->setObjectName(QStringLiteral("labelEuroTitle"));
        ...
        labelEuroAmount->setObjectName(QStringLiteral("labelEuroAmount"));
