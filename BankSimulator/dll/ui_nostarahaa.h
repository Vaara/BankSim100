...
public:
    ...
    void retranslateUi(QWidget *NostaRahaa)
    {
        ...
        label->setText(QApplication::translate("NostaRahaa", "Withdraw", Q_NULLPTR));
        buttonPalaaAlkuun->setText(QApplication::translate("NostaRahaa", "Back", Q_NULLPTR));
        buttonNosta40->setText(QApplication::translate("NostaRahaa", "40\342\202\254", Q_NULLPTR));
        buttonSyotaSumma->setText(QApplication::translate("NostaRahaa", "Enter amount", Q_NULLPTR));
