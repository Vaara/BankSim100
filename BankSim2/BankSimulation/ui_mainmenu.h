...
public:
    ...
    void setupUi(QWidget *MainMenu)
    {
        ...
        label->setGeometry(QRect(340, 40, 101, 41));
        QFont font;
        ...
        font2.setBold(false);
        font2.setWeight(50);
        buttonTilinSaldo->setFont(font2);
    ...
    void retranslateUi(QWidget *MainMenu)
    {
        ...
        label->setText(QApplication::translate("MainMenu", "ATM", Q_NULLPTR));
        buttonKirjauduUlos->setText(QApplication::translate("MainMenu", "Logout", Q_NULLPTR));
        buttonTilitapahtumat->setText(QApplication::translate("MainMenu", "transactions", Q_NULLPTR));
        buttonTilinSaldo->setText(QApplication::translate("MainMenu", "Account balance", Q_NULLPTR));
        buttonNostaRahaa->setText(QApplication::translate("MainMenu", "Withdraw", Q_NULLPTR));
    } // retranslateUi
