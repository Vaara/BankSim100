...
public:
    ...
    void retranslateUi(QWidget *NostaOmaSumma)
    {
        ...
        label->setText(QApplication::translate("NostaOmaSumma", "Enter Amount", Q_NULLPTR));
        buttonBack->setText(QApplication::translate("NostaOmaSumma", "BACK", Q_NULLPTR));
        ...
        buttonEnter->setText(QApplication::translate("NostaOmaSumma", "WITHDRAW", Q_NULLPTR));
