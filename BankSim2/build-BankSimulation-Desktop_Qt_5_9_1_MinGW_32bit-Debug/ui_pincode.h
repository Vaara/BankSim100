...
public:
    ...
    void setupUi(QWidget *PinCode)
    {
        ...
        label->setGeometry(QRect(220, 40, 401, 51));
        QFont font1;
    ...
    void retranslateUi(QWidget *PinCode)
    {
        ...
        label->setText(QApplication::translate("PinCode", "Sy\303\266t\303\244 PIN-Koodi", Q_NULLPTR));
        button2->setText(QApplication::translate("PinCode", "2", Q_NULLPTR));
        button5->setText(QApplication::translate("PinCode", "5", Q_NULLPTR));
        buttonBack->setText(QApplication::translate("PinCode", "TAKAISIN", Q_NULLPTR));
